      ...
      <table >
        <tbody>
          <tr>
            <td>
              {" "}
              <button type="button" className="btn btn-primary" onClick={ReportsHandler}>
                Reports
              </button>
            </td>
            <td>
              <button type="button" className="btn btn-primary" onClick={AttendanceHandler}>
                Attendance            </button>
            </td>
          <td><button type="button" className="btn btn-primary" onClick={RetailerHandler}>
            Retailers
            </button></td>
